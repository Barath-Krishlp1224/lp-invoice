                                        ...
                                        <button onClick={downloadMergedPdfOnly} disabled={isPdfActionInProgress || isViewingInTabs} className="inline-flex min-w-[11rem] items-center justify-center px-6 py-2 bg-green-600 text-white hover:bg-green-700 rounded-lg text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                                            {isDownloadingMerged ? (
                                                ...
                                                <>
                                                    ...
                                                    {`Download Merged PDF (${filteredPreviewRows.length})`}
                                                </>
                                            )}
                                        </button>
                            ...
                            <div className="border-t border-gray-200 bg-white p-5 md:p-7">
                                ...
                                <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                    ...
                                    <div className="flex flex-wrap items-center gap-2">
                                        ...
                                        <button onClick={goToNextPage} disabled={currentPage === filteredTotalPages} className="flex items-center justify-center px-3 py-1 text-xs font-medium text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors">
            ...
            <div className="fixed bottom-4 right-4 z-40 left-4 md:bottom-6 md:left-auto md:right-6">
                {isMerchantNotesOpen && (
                    <div className="mb-3 w-full overflow-hidden rounded-[24px] border border-[#d7dbc7] bg-[#fffef7] shadow-[0_20px_60px_rgba(15,23,42,0.18)] md:ml-auto md:w-[820px] md:max-w-[calc(100vw-3rem)] md:rounded-[28px]">
                        ...
                        <div className="max-h-[min(78vh,44rem)] overflow-y-auto p-4 md:p-5">
                            ...
                            {selectedNoteMerchantConfig && (
                                <div className="flex min-h-[24rem] flex-col rounded-2xl border border-[#e4dfc5] bg-white p-4 md:h-[560px]">
                ...
                <button
                    ...
                    className="ml-auto flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-green-600 to-emerald-500 text-white shadow-[0_18px_40px_rgba(22,163,74,0.35)] transition-transform hover:scale-105"
