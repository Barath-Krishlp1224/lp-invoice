...
const MERCHANT_CONFIGS = {
    ...
    others: {
        apextech: {
            ...
            invoiceCode: '00',
            address: 'NO. 32, NEDU STREET, VISWANATHAPURAM, NELLIKKUPPAM, PANRUTI, CUDDALORE - 607105, TAMIL NADU.<br/>GST: 33ABACA7708F1Z0',
            receiptEntityName: 'ATLP',
        ...
        bytes_napse: {
            ...
            invoiceCode: '45',
            address: 'PLT NO. 27, 2ND CROSS, NORTH STREET, THENGAITHITTU, PONDICHERRY - 605004, PONDICHERRY.<br/>GST: 34AANCB0540Q1ZF',
        ...
        bytes_sparkz: {
            ...
            invoiceCode: '48',
            address: 'NO 32, NEDU STREET, VISWANATHAPURAM, NELLIKKUPPAM, PANRUTI, CUDDALORE - 607105, TAMIL NADU.<br/>GST: 33AANCB1761F1ZV',
        ...
        cipher_byte: {
            ...
            invoiceCode: '60',
            address: 'NO. 4, NATTAR STREET, SECOND CROSS, MOUROUNGAPAKKAM, PONDICHERRY - 605004, PONDICHERRY.<br/>GST: 34AAMCC1682K1ZE',
        ...
        code_horizon: {
            ...
            companyName: 'CODEHORIZON SOFTWARE SOLUTIONS PRIVATE LIMITED',
            invoiceCode: '10',
            address: 'NO. 424, MAIN ROAD, NPM, NELLIKKUPPAM, PANRUTI, CUDDALORE - 607105, TAMIL NADU.<br/>GST: 33AAMCC3726A1Z4',
        ...
        logic_nook: {
            ...
            companyName: 'LOGICNOOK SOFTECH SOLUTIONS PRIVATE LIMITED',
            invoiceCode: '42',
            address: 'NO. 29, GOPU NAGAR, SF NO.34/1, PADIRIKUPPAM, CUDDALORE - 607401, TAMIL NADU.<br/>GST: 33AAGCL0103N1ZT',
        ...
        novalogic: {
            ...
            invoiceCode: '96',
            address: 'NO, 15, 2 CRS, POONGAVANAM, GARDEN MANAVELY, ARIYANKUPPAM, PONDICHERRY - 605007, PONDICHERRY.<br/>GST: 34AAKCN1154D1ZT',
        ...
        orionbyte: {
            ...
            invoiceCode: '04',
            address: 'NO 424, MAIN ROAD, NELLIKKUPPAM, PANRUTI, CUDDALORE - 607105, TAMILNADU<br/>GST: 33AAECO4187B1ZP',
            receiptEntityName: 'OBLP',
        ...
        voltiq: {
            ...
            invoiceCode: '63',
            address: 'NO 15, MANDAPA STREET, THIRUVAIYARU, ANAIKUDY, THANJAVUR - 613204, TAMIL NADU.<br/>GST: 33AAKCV1375L1ZZ',
        ...
        zoving_business: {
            ...
            aliases: [
                'zovingbusiness',
                'zoving business',
                'zovingbusinesssoftwaresolutionsprivatelimited',
                'zovingbusinesssoftwaresolutionspvtltd',
            ],
        },
    },
};
